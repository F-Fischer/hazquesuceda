    ...
    <div class="col-md-9">
        ...
        <div class="col-md-3">
            ...
            <ul class="nav nav-pills nav-stacked" >
                ...
                <li role="presentation" class="active"><a href="archivo">Archivo</a></li>
                ...
                <div class="col-md-6">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <label for="inputFilePDF">Archivo PDF</label>
                            <input type="file" id="inputFilePDF">
                            <p class="help-block">Seleccione un archivo formato .pdf</p>
                        </div>
