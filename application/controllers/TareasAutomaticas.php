                                                        ...
                                                        <table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width=\"100%\">
                                                            <tr>
                                                                <td align=\"center\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif;\">
                                                                    <h2 style=\"font-size: 28px; color: #444444; margin: 0; padding-bottom: 10px;\">Recordatorio de Haz que suceda!</h2>
                                                                    <p style=\"color: #999999; font-size: 16px; line-height: 24px; margin: 0;\">
                                                                      Queremos recordarte que a tu proyecto <strong>" . $nombre. " </strong> le quedan tan solo <strong>" . $diasRestantes. " </strong> días restantes.
                                                                    </p>
                                                                    <br />
                                                                    <label>Si todavía no conseguiste financiación, ingresá a la plataforma y renová tu proyecto! </label>
                                                                    <p style=\"color: #999999; font-size: 16px; line-height: 24px; margin: 0;\">
